    ...
    <div className="min-h-screen bg-brand-cream-light pb-24">
      ...
      <div className="container mx-auto max-w-3xl space-y-4 px-4 py-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-amber-200 bg-white px-4 py-3 text-sm font-black text-amber-600 shadow-sm hover:bg-amber-50"
        >
          ...
          <div className="w-full max-w-sm rounded-3xl bg-white p-5 shadow-2xl">
            ...
            <div className="mt-5 flex gap-2">
              ...
              <button
                ...
                className="flex-1 rounded-xl border border-brand-cream bg-white py-3 text-sm font-bold text-brand-black hover:bg-brand-cream-light"
              >
                Batal
              </button>
