...
export default function CabangPage() {
  ...
  return (
    <div className="space-y-5 pb-20">
      <PageHeader title="Informasi & Lokasi Toko" subtitle="Atur teks header dan detail halaman lokasi customer" icon={Store} variant="orange" />
      ...
      <Grid cols={2}>
        <Section title="Detail Alamat" subtitle="Nama toko, alamat, dan Google Maps" icon={<MapPin className="h-4 w-4" />}>
          ...
          <Input label="Google Maps Embed URL" value={data.mapsUrl} onChange={(e)=>handleChange("mapsUrl", e.target.value)} placeholder="https://www.google.com/maps/embed?pb=..." hint="Google Maps â†’ Bagikan â†’ Sematan peta â†’ Salin URL src" className="font-mono text-[10px]" />
        </Section>
